...
const pizzaMenor = pizzas.some((pizza) => {
  if (pizza.precio < 600) {
    console.log("Hay alguna pizza que vale menos de 600");
  }
});

// El nombre de cada pizza con su respectivo precio.

const pizzaPrecioNombre = pizzas.map((pizza) => {
...
const ingredientesPizza = pizzas.forEach((pizza) => {
...
const modificarPrecio = pizzas.map((producto) => {
